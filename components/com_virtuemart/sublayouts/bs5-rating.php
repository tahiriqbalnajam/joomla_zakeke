...
<?php if ($viewData['showRating']) : ?>
	...
	<?php else : ?>
		<?php $ratingwidth = $product->rating * 16; ?>
		<div class="vm-ratingbox-container d-inline-block position-relative">
			...
			<div class="vm-ratingbox-rated d-inline-block" title="<?php echo (vmText::_("COM_VIRTUEMART_RATING_TITLE") . ' ' . round($product->rating, 2) . '/' . $maxrating) ?>" data-bs-toggle="tooltip">
