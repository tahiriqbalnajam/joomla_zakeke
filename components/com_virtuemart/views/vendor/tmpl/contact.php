...
/* If you do not want to use the upper function, you can call the fields by name directly
echo $this->userFields['email'] ;
*/
	...
	if(VmConfig::get('ask_question_vendor', false)){ 
?>
