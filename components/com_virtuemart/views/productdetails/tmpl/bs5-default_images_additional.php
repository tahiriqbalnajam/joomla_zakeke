		...
		<div class="col-3">
			<?php
				if (VmConfig::get('add_img_main', 1)) {
					echo $image->displayMediaThumb(array('class'=>"product-image img-thumbnail", 'style'=>"cursor: pointer", 'data-descr'=>$image->file_description), false, '', true, $descr);
					...
					echo $image->displayMediaThumb('class="product-image img-thumbnail"',true,"rel='vm-additional-images'",true, $descr);
				}
			?>
		</div>
	<?php
