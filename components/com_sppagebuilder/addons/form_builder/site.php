...
class SppagebuilderAddonForm_builder extends SppagebuilderAddons
{
	...
	public function render()
	{
		...
		$captcha_selector = ($captcha_type == 'zencaptcha' ? 'zenc-captcha-solution' : '');
		...
		if ($enable_captcha && $captcha_type == 'default') {
			...
			$recaptcha = Factory::getApplication()->triggerEvent('onDisplay', array(null, 'custom_captcha_' . $addon_id, 'sppb-dynamic-recaptcha'));
