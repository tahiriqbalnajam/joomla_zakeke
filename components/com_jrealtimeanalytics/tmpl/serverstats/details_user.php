...
<div class="jes">
		...
		<div class="card card-default accordion-group">
			<div class="card-header accordion-heading">
				<div class="accordion-toggle accordion_lightblue noaccordion">
					<h3><?php echo Text::sprintf('COM_JREALTIME_SERVERSTATS_USERS_DETAILS', '<span class="badge badge-info">' . @$this->detailData[0]->customer_name) . '</span>'; ?></h3>
				</div>
			</div>
					...
					<thead>
						<tr>
							...
							<?php if($this->cparams->get('xtd_singleuser_stats', 0)) :?>
								...
								<th><span class="badge badge-info"><?php echo Text::_('COM_JREALTIME_SERVERSTATS_EMAIL');?></span></th>
							<?php endif;?>
						</tr>
					</thead>
					<tbody>
	...
	<?php if($this->canExport):?>
		<a class="headstats btn btn-primary btn-xs csv" download href="<?php echo \JRealtimeRoute::_('index.php?option=com_jrealtimeanalytics&amp;task=serverstats.showEntitycsv&amp;tmpl=component&amp;details=user&amp;identifier=' . rawurlencode($this->detailData[0]->session_id_person));?>">
			<span class="icon-chart" aria-hidden="true"></span>
			<?php echo Text::_('COM_JREALTIME_EXPORTCSV' ); ?>
		</a>
		<a class="headstats btn btn-primary btn-xs xls" download href="<?php echo \JRealtimeRoute::_('index.php?option=com_jrealtimeanalytics&amp;task=serverstats.showEntityxls&amp;tmpl=component&amp;details=user&amp;identifier=' . rawurlencode($this->detailData[0]->session_id_person));?>">
			<span class="icon-chart" aria-hidden="true"></span>
			<?php echo Text::_('COM_JREALTIME_EXPORTXLS' ); ?>
		</a>
		<a class="headstats btn btn-primary btn-xs pdf" href="<?php echo \JRealtimeRoute::_('index.php?option=com_jrealtimeanalytics&amp;task=serverstats.showEntitypdf&amp;tmpl=component&amp;details=user&amp;identifier=' . rawurlencode($this->detailData[0]->session_id_person));?>">
			<span class="icon-chart" aria-hidden="true"></span>
