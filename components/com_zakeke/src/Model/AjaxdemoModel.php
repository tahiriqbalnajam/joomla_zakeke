<?php
namespace Zakeke\Component\Tasks\Site\Model;
...
class AjaxdemoModel extends \Joomla\CMS\MVC\Model\FormModel
{
    ...
    {
        $form = $this->loadForm(
            'com_zakeke.divide',      // a unique name to identify the form
    ...
    protected function loadFormData()
    {
        ...
        $data = Factory::getApplication()->getUserState(
            'com_zakeke.divide',  // a unique name to identify the data in the session
