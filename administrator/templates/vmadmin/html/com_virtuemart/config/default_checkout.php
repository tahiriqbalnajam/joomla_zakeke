 ...
 * @copyright Copyright (c) 2004 - 24 Virtuemart Team. All rights reserved. 
 * @license http://www.gnu.org/copyleft/gpl.html GNU/GPL, see LICENSE.php
 * VirtueMart is free software. This version may have been modified pursuant
 * to the GNU General Public License, and as distributed it includes or
 * is derivative of works licensed under the GNU General Public License or
 * other free or open source software licenses.
 * @version $Id: default_checkout.php 11091 2024-11-11 11:55:27Z Milbo $
 */
...
<div class="uk-card uk-card-small uk-card-vm">
	...
	<div class="uk-card-body">
		...
		echo VmuikitHtml::row('booleanlist','COM_VM_REGISTER_NEED_PRODUCT_IN_CART','regNeedProdCart',VmConfig::get('regNeedProdCart',0));
