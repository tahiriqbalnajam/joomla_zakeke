...
* @version $Id: list_reviews.php 10722 2022-10-23 20:52:25Z Milbo $
*
		...
		foreach ($this->reviewslist as $key => $review) {
			...
			<tr class="row<?php echo ($i)%2 ; ?>">
				...
				foreach ($activeVMLangs as $key => $activeVMLang) {
				    ...
				    echo '<option  value="'.$activeVMLang.'::'.$review->virtuemart_rating_review_id.'" '.$selected.'>'.$activeVMLang.'</option >';
