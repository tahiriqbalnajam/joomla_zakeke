...
* @version $Id: user.php 10859 2023-05-30 16:03:47Z Milbo $
*/
...
class VirtuemartControllerUser extends VmController {
	...
	function removeAddressST(){
		...
		$this->setRedirect( 'index.php?option=com_virtuemart&view=user&task=edit&virtuemart_user_id[]='.$virtuemart_user_id );
	}
