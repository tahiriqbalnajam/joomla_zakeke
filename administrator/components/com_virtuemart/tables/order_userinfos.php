 ...
 * @version $Id: order_userinfos.php 10899 2023-07-15 17:23:30Z Milbo $
 */
...
class TableOrder_userinfos extends VmTable {
	...
	function check(){
    	...
    	if(isset($this->virtuemart_state_id) and empty($this->virtuemart_state_id)){
		    $this->virtuemart_state_id = 0;
	    }
    	return parent::check();
	}
}
