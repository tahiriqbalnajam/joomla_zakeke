...
class VmHtml{
	 ...
	 * @return string
	 */
	//static function JRadiolist( $data, $name, $attribs = null, $optKey = 'value', $optText = 'text', $selected = null, $idtag = false, $translate = false)
	 ...
	 * @copyright (C) 2023 The VirtueMart Team
	 ...
	 * @since   1.5
	 */
	public static function JRadiolist(
		$data,
		$name,
		$attribs = null,
		$optKey = 'value',
