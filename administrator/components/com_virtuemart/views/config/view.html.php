...
class VirtuemartViewConfig extends VmViewAdmin {
	...
	function display($tpl = null) {
		...
		$this->vmLayoutList = VirtueMartModelConfig::getLayoutList('virtuemart');

		$this->cartLayoutList = VirtueMartModelConfig::getLayoutList('cart',array('padded.php','perror.php','orderdone.php'), true);
		$this->categoryLayoutList = VirtueMartModelConfig::getLayoutList('category', 0, true);

		$this->productLayoutList = VirtueMartModelConfig::getLayoutList('productdetails', 0, true);

		$this->productsFieldList  = VirtueMartModelConfig::getFieldList('products');
