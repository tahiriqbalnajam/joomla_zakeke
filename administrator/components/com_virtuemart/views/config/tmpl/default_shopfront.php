 ...
 * @version $Id: default_shopfront.php 11064 2024-10-04 10:55:59Z Milbo $
 */
...
, 'customers' => vmText::_('COM_VM_ASK_QUESTION_CUSTOMERS')
    ...
    echo VmHTML::row('checkbox','COM_VIRTUEMART_ASK_QUESTION_VENDOR_SHOW','ask_question_vendor',VmConfig::get('ask_question_vendor',0));
