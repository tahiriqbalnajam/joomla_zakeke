 ...
 * @version $Id: order.php 10966 2024-01-24 12:57:00Z  $
 */
...
<table class="adminlist table table-striped" width="100%">
	<tr>
		...
		$this->createPrintLinks($this->orderbt,$print_link,$deliverynote_link,$invoice_link);
		?>
...
$j = 'jQuery(document).ready(function ($) {
        $("#order-items-table").dynoTable({
            ...
            onBeforeRowInsert:function (newTr) {
            	/*var randomNumber = 0;//Math.floor(Math.random() * 100);
