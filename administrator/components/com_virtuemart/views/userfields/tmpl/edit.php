...
* @version $Id: edit.php 10994 2024-04-17 09:39:44Z  $
*/
...
<div class="col50">
 ...
 echo VmHTML::row('input','COM_VIRTUEMART_FIELDMANAGER_PLACEHOLDER','placeholder',$this->userField->placeholder,'class="inputbox"','', 50, '255', '('.$text.')');
		...
		?>
		<?php echo VmHTML::row('input','COM_VIRTUEMART_FIELDMANAGER_HTML_CLASSES','html_classes',$this->userField->html_classes,'class="inputbox"','',50, '155'); ?>
