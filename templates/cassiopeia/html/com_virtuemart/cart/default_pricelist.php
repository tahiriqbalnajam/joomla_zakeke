...
foreach ($this->cart->products as $pkey => $prow) {
	//file_put_contents('D:/laragon/www/joomla/templates/cassiopeia/html/com_virtuemart/cart/product_output.txt', print_r($prow, true));
	//e/cho $prow->virtuemart_product_id;
	$prow->prices = array_merge($prow->prices,$this->cart->cartPrices[$pkey]);
	//var_dump($prow->customProductData);
	//var_dump($prow->customProductData[$prow->virtuemart_product_id]['10073']['comment']);
?>
