...
<div class="product-container productdetails-view productdetails">
    ...
    <div class="vm-product-container">
        <div class="vm-product-media-container">
            <!-- Embed Zakeke Product Customizer -->
            <div class="container">
                <div id="zakeke-container">
                    <!-- Zakeke customizer content will be loaded here -->
                </div>
            </div>
        </div>
		<script
			src="https://portal.zakeke.com/scripts/integration/apiV2/customizer.js">
		</script>
		<script>
			...
			var config = {
				tokenOauth: "dummyTokenOauth",
				productId: "590977",
				productName: "Dummy Product",
				getProductInfo: function() { return { info: "Dummy product info" }; },
				getProductPrice: function() { return { price: 99.99 }; },
				getProductAttribute: function() { return { attribute: "Dummy attribute" }; },
				// Add to cart
				cartButtonText: "Add To Cart",
				addToCart: function() { console.log("Dummy add to cart"); },
				editAddToCart: function() { console.log("Dummy edit add to cart"); },
				// Name and numbers (add to cart and edit product)
				isNamesAndNumbers: false,
				addToCartNameAndNumber: function() { console.log("Dummy add to cart name and number"); },
				editAddToCartNameAndNumber: function() { console.log("Dummy edit add to cart name and number"); },
				// Bulk variations purchase (add to cart end edit product)
				isMultipleVariations: true,
				addToCartBulk: function() { console.log("Dummy add to cart bulk"); },
				editAddToCartBulk: function() { console.log("Dummy edit add to cart bulk"); },
				isBulkIndividualFile: true,
				// Share design 
				isSharedDesignUrl: true,
				getSharedDesign: function() { return { url: "http://dummy.store.com/sharedDesign" }; },
				ShareUrlPrefix: "http://dummy.store.com/",
				// Save design
				isSaveDesign: true,
				getSaveDesign: function() { return { design: "Dummy saved design" }; },
				//--
				onBackClicked: function() { console.log("Dummy back clicked"); },
				//--
				designId: "",
				hideVariants: true,
