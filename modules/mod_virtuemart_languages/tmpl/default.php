 ...
 * @author Max Milbers
 * @copyright	Copyright (C) 2005 - 2014 Open Source Matters, Inc. All rights reserved. 2015 iStraxx GmbH
	...
	<?php foreach ($list as $language) : ?>
		<?php if ($params->get('show_active', 0) || !$language->active):?>
			...
			<a href="<?php echo $language->link;?>">
				<?php
				$document->addHeadLink( $language->link , 'alternate', 'rel',array('hreflang'=>$language->lang_code) );
