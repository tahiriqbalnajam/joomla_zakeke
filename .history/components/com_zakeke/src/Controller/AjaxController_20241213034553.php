...
class AjaxController extends BaseController
{
    ...
    public function addproduct()
    {
        ...
        $designid = $input->getInt('designid', 1);
        ...
        try {
            ...
            $customData = array(
                'custom_design_id' => $input->getString('design_id', ''),
                'custom_preview_url' => $input->getString('preview_url', ''),
                'custom_options' => $input->getString('options', '')
            );
            $post = array(
