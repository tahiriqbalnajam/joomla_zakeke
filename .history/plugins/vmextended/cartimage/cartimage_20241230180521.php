...
$apiToken = getenv('ZAKEKE_API_TOKEN'); // Ensure this environment variable is set with your API token

// Check if the API token is available
if (!$apiToken) {
    die('API Token is missing. Please set it in your environment variables.');
}

// Prepare the order data payload
$orderData = [
    'orderCode' => 'ORDER12345', // Unique identifier of the order on the e-commerce platform
    ...
    'details' => [
        [
            ...
            'designID' => 'DESIGN456',      // Unique design identifier provided by Zakeke
