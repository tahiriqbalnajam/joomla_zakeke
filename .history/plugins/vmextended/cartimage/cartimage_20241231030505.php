...
class PlgVMExtendedCartimage extends vmCustomPlugin
{
    ...
    public function plgVmConfirmedOrder($cart, $order)
    {
        ...
        foreach ($cart->products as $product) {
            ...
            $customFields = $customFieldModel->getCustomEmbeddedProductCustomFields([$product->virtuemart_product_id]);
            ...
            foreach ($customFields as $customField) {
                if ($customField->custom_title == 'zakek_designid') {
                    ...
                    $orderData = [
                        ...
                        'sessionID' => $cart->virtuemart_session_id, // E-commerce session identifier
                    ...
                    curl_close($curl);
                    //echo $customField->virtuemart_product_id.'<br>';
            ...
            $designId = $product->customProductData['22']['191']['comment'];
            if (!empty($designId)) {
                // Your existing code to handle the designId
            }
        }
        if (!empty($designId)) {
