...
class PlgVMExtendedCartimage extends vmCustomPlugin
{
    ...
    {
        echo '<pre>';
        print_r($product->customProductData['22']['191']['comment']);
        echo '</pre>';
            if ($productCustom->custom_title == 'zakek_designid' && !empty($product->customProductData['22']['191']['comment'])) {
                echo 'zakeke design';
                $zakek_designid = $productCustom->custom_value;
