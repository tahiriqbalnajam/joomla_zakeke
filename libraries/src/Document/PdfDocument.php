...
* @subpackage	Document
* @copyright	Copyright (C) 2005 - 2010 Open Source Matters. 2012 - 2022 VirtueMart. All rights reserved.
...
class JDocumentPDF extends JDocument
{
	...
	function render( $cache = false, $params = array())
	{
		...
		$app->setHeader('Content-disposition', 'inline; filename="'.$this->getName().'.pdf"', true);
