 ...
 * @version $Id: realex_hpp_api.php 11043 2024-08-14 19:46:19Z Milbo $
 * @package VirtueMart
 * @subpackage payment
			...
			if ($first) {
				...
				if (isset($payment->realex_hpp_api_fullresponse) and !empty($payment->realex_hpp_api_fullresponse)) {
					...
					if ($payment->realex_hpp_api_fullresponse_format == 'json') {
						$realex_data = json_decode($payment->realex_hpp_api_fullresponse, true);
...
// is this plugin already
	...
	private function createPayerRefTable ($tablesFields = 0) {
	    ...
	    ) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Realex PayerRef Table' AUTO_INCREMENT=1 ;";
